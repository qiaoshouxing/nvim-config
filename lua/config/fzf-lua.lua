...
vim.keymap.set("n", "<leader>fgg", "<cmd>FzfLua grep_cword<cr>", { desc = "Fuzzy grep files" })
vim.keymap.set("n", "<leader>fg", "<cmd>FzfLua live_grep<cr>", { desc = "Fuzzy live grep files" })
